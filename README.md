...
1. В файле main.py реализовать функцию *get_triangle_path_count*, принимающую длину маршрута и возвращающую количество маршрутов заданной длины между тремя вершинами. **Для реализации обязательно использовать взаимную рекурсию**.
