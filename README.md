...
2. **Распределение инвестиций между проектами необходимо восстановить после расчета максимально возможной суммы прибыли. Запрещено сохранять данные о распределении в процесе расчетов таблицы динамического программирования** 
