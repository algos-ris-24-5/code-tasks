# Задание №2 - Варианты 1 и 3
## Вариант 1. Вычисление определителя
...
## Вариант 3. Вычисление генератор тестовых данных для проверки вычисления определителя матрицы
...
### P.S.
Полезную информацию о порядке выполнения задания, установке и настройке необходимого ПО можно посмотреть в репозитории [docs](https://github.com/algos-ris-24-5/docs)